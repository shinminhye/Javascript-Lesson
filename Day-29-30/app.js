...
const btnMultiply = document.querySelector('[x-data-pad-btn="AM"]');

function onBtnMultiplyClick(){
    btnMultiply.style.backgroundColor = 'red';
}
btnMultiply.onclick = onBtnMultiplyClick // function () { onBtnMultiplyClick(); }
